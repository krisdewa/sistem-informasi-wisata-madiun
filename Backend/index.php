...
<head>
    ...
    <title>Admin Wisata - Dashboard</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800">Selamat Datang <?php echo $_SESSION['nama']; ?></h1>
                        <!-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> -->
                    </div>

                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-500">Dashboard Jumlah Data</h1>
                        <!-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> -->
                    </div>
                    ...
                    <div class="row">
                        <?php
                            ...
                            $data_wisata = mysqli_query($connect,"SELECT * FROM tbl_wisata");
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xxs font-weight-bold text-primary text-uppercase mb-1">
                                                <a class="" href="administrator.php"> ADMIN </a>
                                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xxs font-weight-bold text-success text-uppercase mb-1">
                                                <a class="" href="wisata.php"> Data Wisata </a>
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_wisata; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xxs font-weight-bold text-warning text-uppercase mb-1">
                                                <a class="" href="testimoni.php"> Data Testimoni </a>
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_testimoni; ?></div>
                                        </div>
                                        <div class="col-auto">
